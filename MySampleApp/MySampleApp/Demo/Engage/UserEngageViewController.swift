...
class UserEngageViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        NotificationCenter.default.addObserver(self, selector:#selector(UserEngageViewController.onRemoteNotificationRegistered) , name: NSNotification.Name(rawValue: AWSMobileClient.remoteNotificationKey), object: nil)
        ...
        let endpoint = AWSMobileClient.sharedInstance.pinpoint!.targetingClient.currentEndpointProfile()
